...
type PingMemsd struct {
}

func (self *PingMemsd) String() string { return proto.CompactTextString(self) }

func (self *PingMemsd) Size() (ret int) {

	return
}

func (self *PingMemsd) Marshal(buffer *proto.Buffer) error {

	return nil
}

func (self *PingMemsd) Unmarshal(buffer *proto.Buffer, fieldIndex uint64, wt proto.WireType) error {
	switch fieldIndex {
